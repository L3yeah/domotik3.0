...
#define HOTSPOT_WIFI  "Pixel_2855"     //veloz       /* Nombre del punto de acceso a conectarse */
#define HOTSPOT_PWD   "napogorda"          //12345678          /* Contraseña de la red */
#define MQTT_SERVER   "test.mosquitto.org"     /* Dirección del Broker MQTT */
#define MQTT_PORT     1883                     /* Puerto del Broker MQTT */
#define TXTOPIC       "/SEIoT/Mondongo"         /* Nombre del topic de publicación */
...
class MQTT {
  ...
  public:
    ...
    void publish_MQTT ( const char * mensaje );              /* Conecta al usuario como un pulicador MQTT */
...
void MQTT :: publish_MQTT (const char * mensaje ) {

  String hola = "Es más dura la verdura";
  Serial.println ( F ( "Publicando información" ) );
  client.publish( TXTOPIC, mensaje);                 /* Función librería PubsubClient */
